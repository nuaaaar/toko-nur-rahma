...
@section('content')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Tambah Penjualan</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="card">
        <div class="card-body">
            <form class="form" action="{{ route('dashboard.sale.store') }}" method="POST">
                @csrf
                ...
                <div class="flex flex-col md:grid  md:grid-cols-6 gap-4 mt-0">
                    ...
                    <div class="col-span-4">
                        <div class="flex flex-col md:grid md:grid-cols-2 gap-4">
                            ...
                            <input type="text" name="total_paid" id="total_paid" class="form-control text-left currency" placeholder="Total Bayar" required style="display: none">
...
@push('script')
    ...
    @foreach (old('sale_items') ?? [] as $saleItem)
        <script>
