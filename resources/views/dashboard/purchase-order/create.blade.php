...
@section('content')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Tambah Purchase Order</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="card">
        <div class="card-body">
            <form class="form" action="{{ route('dashboard.purchase-order.store') }}" method="POST">
                @csrf
                ...
                <div class="flex flex-col md:grid  md:grid-cols-12 gap-4 mt-0">
                    <div class="col-span-3">
                        ...
                        <input type="text" name="customer[phone_number]" id="customer_phone_number" class="@error('customer.phone_number') is-invalid @enderror form-control" placeholder="" value="{{ old('customer.phone_number') ?? '' }}" required>
                    ...
                    <div class="col-span-3">
                        ...
                        <input type="text" name="customer[name]" id="customer_name" class="@error('customer.name') is-invalid @enderror form-control" placeholder="" value="{{ old('customer.name') ?? '' }}" required>
                        @error('customer.name')
                            <span class="invalid-feedback" category="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-span-4">
                        ...
                        <input type="text" name="customer[address]" id="customer_address" class="@error('customer.address') is-invalid @enderror form-control" placeholder="" value="{{ old('customer.address') ?? '' }}" required>
...
@push('script')
    ...
    @foreach (old('purchase_order_items') ?? [] as $purchaseOrderItem)
        <script>
